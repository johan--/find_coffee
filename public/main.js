...
},{"react":203}],2:[function(require,module,exports){
/** @jsx React.DOM */
var React        = require('react'),
    ...
    return (
        React.createElement("div", null, 
          ...
          React.createElement("section", {id: "mainContent"}, 
            React.createElement(RouteHandler, {offerings: this.props.offerings})
          )
        )
    );
  }
...
},{"./myHeader.jsx":6,"react":203,"react-router":34}],3:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');

module.exports = React.createClass({displayName: "exports",
  render: function() {
    return React.createElement("button", {name: this.props.name}, this.props.text);
  }
});
...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function() {
    ...
    return React.createElement("li", null, React.createElement("a", {href: url}, React.createElement("span", null, name, " | ", roaster)));
  }
});
...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function() {
    var offerings = this.props.offerings.map(function(offering) {
      return React.createElement(Offering, {offering: offering, key: offering._id});
    });
...
},{"./Offering.jsx":4,"react":203}],6:[function(require,module,exports){
/** @jsx React.DOM */
var React  = require('react'),
...
},{"./Button.jsx":3,"react":203}],7:[function(require,module,exports){
/** @jsx React.DOM */
var React  = require('react'),
    Router = require('react-router');
...
Router.run(routes, Router.HistoryLocation, function(Handler) {
    React.render(React.createElement(Handler, {user: name, offerings: offerings}),
        document.getElementById('mount-point'));
});

},{"./reactRoutes.jsx":8,"react":203,"react-router":34}],8:[function(require,module,exports){
/** @jsx React.DOM */
var React         = require('react'),
    Router        = require('react-router'),
...
module.exports = [
  React.createElement(Route, {handler: App, path: "/"}, 
    React.createElement(DefaultRoute, {name: "list", handler: OfferingList}), 
    React.createElement(NotFoundRoute, {handler: NotFound})
  )
];

},{"./components/404.jsx":1,"./components/App.jsx":2,"./components/OfferingList.jsx":5,"react":203,"react-router":34}],9:[function(require,module,exports){
